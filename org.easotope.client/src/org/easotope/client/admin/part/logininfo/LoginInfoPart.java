...
public class LoginInfoPart extends ChainedPart {
	private static final String SELECTION_IGNORE_THIS = "SELECTION_IGNORE_THIS";

	private LoginInfoComposite loginInfoComposite;
	...
	public void postConstruct() {		
		...
		loginInfoComposite = new LoginInfoComposite(this, getParent(), SWT.NONE);
		FormData formData = new FormData();
		formData.top = new FormAttachment(0);
		formData.left = new FormAttachment(0);
		formData.right = new FormAttachment(100);
		formData.bottom = new FormAttachment(100);
		loginInfoComposite.setLayoutData(formData);
