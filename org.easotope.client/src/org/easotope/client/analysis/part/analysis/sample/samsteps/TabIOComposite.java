...
public class TabIOComposite extends EasotopeComposite {
	...
	TabIOComposite(EasotopePart easotopePart, Composite parent, int style) {
		...
		label.setLayoutData(formData);
 		label.setText(Messages.samTabIoComposite_inputsLabel);
		...
		tableInputColumn1.setText(Messages.samTabIoComposite_description);
		final TableColumn tableInputColumn2 = new TableColumn(inputsTable, SWT.NONE);
		tableInputColumn2.setText(Messages.samTabIoComposite_column);
		...
		label.setLayoutData(formData);
 		label.setText(Messages.samTabIoComposite_outputsLabel);
		...
		tableOutputColumn1.setText(Messages.samTabIoComposite_description);
		final TableColumn tableOutputColumn2 = new TableColumn(outputsTable, SWT.NONE);
		tableOutputColumn2.setText(Messages.samTabIoComposite_column);
	...
	void setInputs(SamStep samStep, StepController controller) {
		inputsTable.removeAll();
		HashMap<String,String> inputMap = samStep.getInputs();
		...
		HashMap<String,String> outputMap = samStep.getOutputs();
