...
public class ErrorComposite extends Composite {
	...
	ErrorComposite(Composite parent, int style) {
		...
		errorTitle.setText(Messages.sampleAnalysisErrorComposite_errorTitle);
		...
		stepLabel.setText(Messages.sampleAnalysisErrorComposite_errorStepLabel);
	
		errorStep = new Label(errorSubComposite, SWT.WRAP);
	
		Label messageLabel = new Label(errorSubComposite, SWT.NONE);
		messageLabel.setText(Messages.sampleAnalysisErrorComposite_errorMessageLabel);
	...
	void setErrorMessage(String step, String message) {
		errorStep.setText(step != null ? step : Messages.sampleAnalysisErrorComposite_unknownStep);
