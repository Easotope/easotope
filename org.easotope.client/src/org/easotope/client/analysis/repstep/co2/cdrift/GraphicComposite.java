...
package org.easotope.client.analysis.repstep.co2.cdrift;

import org.easotope.client.Messages;
import org.easotope.client.core.part.EasotopePart;
import org.easotope.shared.analysis.repstep.co2.cdrift.Calculator;
...
public class GraphicComposite extends org.easotope.client.analysis.repstep.superclass.drift.GraphicComposite {
	...
	public String getHorizontalLabel() {
		return Messages.co2CDriftGraphicComposite_horizontalLabel;
	}

	@Override
	public String getVerticalLabel() {
		return Messages.co2CDriftGraphicComposite_verticalLabel;
	}
}
