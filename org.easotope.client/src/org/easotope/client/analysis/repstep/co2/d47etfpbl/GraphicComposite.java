...
package org.easotope.client.analysis.repstep.co2.d47etfpbl;
...
public class GraphicComposite extends org.easotope.client.analysis.repstep.superclass.etfpbl.GraphicComposite {
	...
	public String getGraph1VerticalLabel() {
		return Messages.d47EtfPbl_graph1VerticalLabel;
	}

	@Override
	public String getGraph1HorizontalLabel() {
		return Messages.d47EtfPbl_graph1HorizontalLabel;
	}
	
	@Override
	public String getGraph2VerticalLabel() {
		return Messages.d47EtfPbl_graph2VerticalLabel;
	}

	@Override
	public String getGraph2HorizontalLabel() {
		return Messages.d47EtfPbl_graph2HorizontalLabel;
	}

	@Override
	public String getCorrectorLabel() {
		return Messages.d47EtfPbl_d47;
	}
	...
	public String getCorrecteePostLabel() {
		return Messages.d47EtfPbl_D47CDES;
	}
}
