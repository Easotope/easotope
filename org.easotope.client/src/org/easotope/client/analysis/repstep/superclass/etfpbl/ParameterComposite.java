...
import org.easotope.shared.analysis.repstep.superclass.etfpbl.Calculator;
...
public class ParameterComposite extends RepStepParamComposite implements StandardCacheStandardListGetListener {
	...
	public ParameterComposite(ChainedPart chainedPart, Composite parent, int style) {
		...
		temperatureLabel.setText(Messages.etfPblParameterComposite_acidTempLabel);
		...
		windowTypeLabel.setText(Messages.etfPblParameterComposite_windowType);
		...
		possibilities.put(WindowType.CorrInterval.ordinal(), Messages.etfPblParameterComposite_corrInterval);
		possibilities.put(WindowType.Window.ordinal(), Messages.etfPblParameterComposite_window);
		windowType.setPossibilities(possibilities);

		Label newStandardsBeforeAndAfterLabel = new Label(this, SWT.NONE);
		newStandardsBeforeAndAfterLabel.setText(Messages.etfPblParameterComposite_newStandardsBeforeAfter);
		...
		standardsLabel.setText(Messages.etfPblParameterComposite_standards);
		...
		averageLabel.setText(Messages.etfPblParameterComposite_averageStandardsFirst);
	...
	protected boolean hasError() {
		...
		if (newTemperatureParseError) {
			acidTemperatureError.setToolTipText(Messages.etfPblParameterComposite_temperatureMustBeValidNumber);
			tempertureErrorSet = true;
		}

		if (acidTemperature.getText().trim().isEmpty()) {
			acidTemperatureError.setToolTipText(Messages.etfPblParameterComposite_temperatureRequired);
			tempertureErrorSet = true;
		}
