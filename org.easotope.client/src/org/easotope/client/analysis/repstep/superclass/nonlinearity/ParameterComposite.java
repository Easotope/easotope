...
import org.easotope.shared.analysis.repstep.superclass.nonlinearity.Calculator;
...
public class ParameterComposite extends RepStepParamComposite implements StandardCacheStandardListGetListener {
	...
	public ParameterComposite(ChainedPart chainedPart, Composite parent, int style) {
		...
		windowTypeLabel.setText(Messages.nonlinearityParameterComposite_windowType);
		...
		possibilities.put(WindowType.CorrInterval.ordinal(), Messages.nonlinearityParameterComposite_corrInterval);
		possibilities.put(WindowType.Window.ordinal(), Messages.nonlinearityParameterComposite_window);
		windowType.setPossibilities(possibilities);

		Label minNumStandardsBeforeAndAfterLabel = new Label(this, SWT.NONE);
		minNumStandardsBeforeAndAfterLabel.setText(Messages.nonlinearityParameterComposite_minNumStandardsBeforeAndAfter);
		...
		standardsLabel.setText(Messages.nonlinearityParameterComposite_standards);
