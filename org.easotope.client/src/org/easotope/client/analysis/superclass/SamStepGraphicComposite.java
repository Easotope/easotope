...
public abstract class SamStepGraphicComposite extends EasotopeComposite {
	public SamStepGraphicComposite(EasotopePart easotopePart, Composite parent, int style) {
		super(easotopePart, parent, style);
	}

	public abstract void newCalculation(ScratchPad<SamplePad> scratchPad);
}
