...
public abstract class LoggingControlAdaptor implements ControlListener {
	@Override
	public final void controlMoved(ControlEvent event) {
		try {
			loggingControlMoved(event);
	...
	public void loggingControlMoved(ControlEvent e) {
