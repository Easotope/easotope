...
public  class LoggingSelectionAdaptor implements SelectionListener {
	@Override
	public final void widgetSelected(SelectionEvent event) {
		try {
			loggingWidgetSelected(event);
	...
	public final void widgetDefaultSelected(SelectionEvent event) {
		try {
			loggingWidgetDefaultSelected(event);
	...
	public void loggingWidgetDefaultSelected(SelectionEvent e) {
