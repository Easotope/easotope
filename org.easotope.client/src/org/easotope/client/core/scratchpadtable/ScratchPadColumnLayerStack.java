...
class ScratchPadColumnLayerStack extends AbstractLayerTransform {
	private ScratchPadColumnHeaderDataProvider columnHeaderDataProvider;

	private ColumnHeaderLayer columnHeaderLayer;
	private DataLayer columnHeaderDataLayer;

	ScratchPadColumnLayerStack(ScratchPadBodyLayerStack bodyLayerStack) {
		columnHeaderDataProvider = new ScratchPadColumnHeaderDataProvider();
	...
	void setColumnNames(String[] columnNames) {
		columnHeaderDataProvider.setColumnNames(columnNames);
	}

	public ScratchPadColumnHeaderDataProvider getColumnHeaderDataProvider() {
