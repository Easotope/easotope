 ...
 */
public class ScratchPadCopyDataCommandHandler extends AbstractLayerCommandHandler<CopyDataToClipboardCommand> {
    ...
    /*
     * Added to prevent copy of rows hidden by the tree layer
     */
    private TreeLayer treeLayer = null;
     ...
     *            <code>null</code>.
     */
    public ScratchPadCopyDataCommandHandler(SelectionLayer selectionLayer, TreeLayer treeLayer) {
     ...
     *            <code>null</code>.
     */
    public ScratchPadCopyDataCommandHandler(SelectionLayer selectionLayer,
    ...
    public boolean doCommand(CopyDataToClipboardCommand command) {
        ...
        : new ScratchPadCopyDataToClipboardSerializer(assembleCopiedDataStructure(), command);
    ...
    protected ILayerCell[][] assembleCopiedDataStructure() {
        ...
        for (Range range : selectedRows) {
            for (int rowPosition = range.start; rowPosition < range.end; rowPosition++) {
                 ...
                 * Added to prevent copy of rows hidden by the tree layer
                 */
            		if (treeLayer == null || !treeLayer.isRowIndexHidden(rowPosition)) {
