...
public class ScratchPadCopyDataToClipboardSerializerOriginal implements ISerializer {

    private final ILayerCell[][] copiedCells;
    private final CopyDataToClipboardCommand command;

    public ScratchPadCopyDataToClipboardSerializerOriginal(ILayerCell[][] copiedCells,
