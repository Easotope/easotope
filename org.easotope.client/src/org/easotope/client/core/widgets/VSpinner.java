...
public class VSpinner extends Spinner {
	...
	public VSpinner(Composite parent, int style) {
		super(parent, style);
	}
	...
	public void setSelectionButLeaveRevertValue(int selected) {
		super.setSelection(selected);
	}
	
	public boolean hasChanged() {
		return oldNumber != this.getSelection();
	}
	
	public void revert() {
		this.setSelection(oldNumber);
	}
