...
public class VText extends Text {
	...
	public void setTextButLeaveRevertValue(String string) {
		super.setText(string);
	}
	...
	public boolean hasChanged() {
		return !oldString.equals(this.getText());
	}

	public boolean hasChangedIfTrimmed() {
		return !oldString.trim().equals(getText().trim());
	}
