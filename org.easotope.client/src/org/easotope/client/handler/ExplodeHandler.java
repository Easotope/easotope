...
import org.easotope.client.rawdata.replicate.ReplicatePart;
...
public class ExplodeHandler {
	...
	public boolean canExecute(IEclipseContext context, @Named(IServiceConstants.ACTIVE_PART) final MContribution contribution) throws InvocationTargetException, InterruptedException {
		if (contribution != null) {
			...
			if (clientObject instanceof ReplicatePart) {
				ReplicatePart replicatePart = (ReplicatePart) clientObject;
				return replicatePart.canExplode();
			}
		}
