...
public class ProjectPart extends ChainedPart {
	public static final String ELEMENTID_BASE = "org.easotope.rawdata.gui.project";
	...
	public void postConstruct() {
		...
		projectComposite = new ProjectComposite(this, getParent(), SWT.NONE);
		FormData formData = new FormData();
		formData.top = new FormAttachment(0);
		formData.left = new FormAttachment(0);
		formData.right = new FormAttachment(100);
		formData.bottom = new FormAttachment(100);
		projectComposite.setLayoutData(formData);
		...
		if (persistedState != null) {
			...
			if (!selection.containsKey(SELECTION_PROJECT_ID)) {
				projectComposite.receiveAddRequest();
			}
		}
	}
