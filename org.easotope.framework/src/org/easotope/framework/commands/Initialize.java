...
public class Initialize extends Command implements CommandThatSetsAuthenticationObjects, CommandThatDoesNotRequireInitializedDb {
	...
	public String getName() {
		...
		return getClass().getSimpleName() + "(password=" + displayedPassword + ")";
	}
	...
	public void execute(ConnectionSource connectionSource, RawFileManager rawFileManager, Hashtable<String,Object> authenticationObjects) throws Exception {
		...
		if (versionDao.isTableExists()) {
			setStatus(Command.Status.EXECUTION_ERROR, Messages.initialize_versionTableExists);
			return;
		}
		...
		if (userDao.isTableExists()) {
			setStatus(Command.Status.EXECUTION_ERROR, Messages.initialize_userTableExists);
			return;
		}

		TableUtils.createTable(connectionSource, Version.class);
		Version version = new Version();
		version.setLastServerVersion(SystemProperty.getVersion());
