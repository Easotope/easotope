...
public class Controller extends RepStepController {
	...
	public String getParameterComposite() {
		return  "org.carbonateresearch.client.analysis.repstep.co2.ethpbl.ParameterComposite";
	}

	@Override
	public String getGraphicComposite() {
		return "org.carbonateresearch.client.analysis.repstep.co2.ethpbl.GraphicComposite";
	}
