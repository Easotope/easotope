...
public class CorrIntervalsNeedRecalcById extends Event {
	...
	public void addCorrIntervalId(Integer corrIntervalId) {
		corrIntervalIds.add(corrIntervalId);
	}

	public HashSet<Integer> getCorrIntervalIds() {
