...
public class RefGassesUpdated extends Event {
	private static final long serialVersionUID = 1L;

	private int massSpecId;
	private ArrayList<RefGas> refGasses = new ArrayList<RefGas>();
	...
	public RefGassesUpdated(int massSpecId) {
	...
	public void addRefGas(RefGas refGas) {
		refGasses.add(refGas);
	}

	public ArrayList<RefGas> getRefGasses() {
		return refGasses;
	}
}
