...
public interface CorrIntervalCacheRepStepParamsSaveListener extends CacheListener {
	public void repStepParamsSaveCompleted(int commandId, RepStepParams repStepParams);
