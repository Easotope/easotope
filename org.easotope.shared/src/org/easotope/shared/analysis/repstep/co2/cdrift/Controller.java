...
public class Controller extends org.easotope.shared.analysis.repstep.superclass.drift.Controller {
	@Override
	public String getStepName() {
		return Messages.repStepCO2CDrift_name;
	}

	@Override
	public String getShortDocumentation() {
		return Messages.repStepCO2CDrift_shortDocumentation;
	}

	@Override
	public String getDocumentationPath() {
		return Messages.repStepCO2CDrift_documentationPath;
	}

	@Override
	public final String getGraphicComposite() {
		return "org.easotope.client.analysis.repstep.co2.cdrift.GraphicComposite";
	}
	...
	public InputDescription[] getInputDescription() {
		return new InputDescription[] {
			new RepInputDescription(Calculator.INPUT_LABEL_δ13C, true, false)
		};
	}
