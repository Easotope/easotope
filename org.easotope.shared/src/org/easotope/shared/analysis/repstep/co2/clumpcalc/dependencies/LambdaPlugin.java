...
public class LambdaPlugin extends DependencyPlugin {
	private SciConstant sciConstant;

	LambdaPlugin() {
		super(SciConstantNames.λ.toString());
	}
	...
	public int requestObject(DependencyManager dependencyManager) {
		return SciConstantCache.getInstance().sciConstantGet(SciConstantNames.λ, dependencyManager);
	}
	...
	public boolean verifyCurrentObject(DependencyManager dependencyManager) {
		return sciConstant != null && sciConstant.getEnumeration() == SciConstantNames.λ;
	}
