...
public class R17VSMOWPlugin extends DependencyPlugin {
	private SciConstant sciConstant;

	R17VSMOWPlugin() {
		super(SciConstantNames.R17_VSMOW.toString());
	}
	...
	public int requestObject(DependencyManager dependencyManager) {
		return SciConstantCache.getInstance().sciConstantGet(SciConstantNames.R17_VSMOW, dependencyManager);
	}
	...
	public boolean verifyCurrentObject(DependencyManager dependencyManager) {
		return sciConstant != null && sciConstant.getEnumeration() == SciConstantNames.R17_VSMOW;
	}
