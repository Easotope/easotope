...
public class R18VSMOWPlugin extends DependencyPlugin {
	private SciConstant sciConstant;

	R18VSMOWPlugin() {
		super(SciConstantNames.R18_VSMOW.toString());
	}
	...
	public int requestObject(DependencyManager dependencyManager) {
		return SciConstantCache.getInstance().sciConstantGet(SciConstantNames.R18_VSMOW, dependencyManager);
	}
	...
	public boolean verifyCurrentObject(DependencyManager dependencyManager) {
		return sciConstant != null && sciConstant.getEnumeration() == SciConstantNames.R18_VSMOW;
	}
