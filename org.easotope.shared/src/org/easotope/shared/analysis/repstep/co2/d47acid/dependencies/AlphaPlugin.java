...
package org.easotope.shared.analysis.repstep.co2.d47acid.dependencies;
...
public class AlphaPlugin extends DependencyPlugin {
	...
	public HashMap<String,String> getPrintableValues(DependencyManager dependencyManager) {
		...
		NumericValue clumped = (acidTemp == null) ? null : acidTemp.getValues().get(AcidTempParameter.clumped.ordinal());
