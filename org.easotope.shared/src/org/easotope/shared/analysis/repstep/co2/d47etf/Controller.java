...
public class Controller extends org.easotope.shared.analysis.repstep.superclass.etf.Controller {
	@Override
	public String getStepName() {
		return Messages.repStepD47ETF_name;
	}

	@Override
	public String getShortDocumentation() {
		return Messages.repStepD47ETF_shortDocumentation;
	}

	@Override
	public String getDocumentationPath() {
		return Messages.repStepD47ETF_documentationPath;
	}
	...
	public String getGraphicComposite() {
		return "org.easotope.client.analysis.repstep.co2.d47etf.GraphicComposite";
	}
	...
	public InputDescription[] getInputDescription() {
		return new InputDescription[] {
			...
			new RepInputDescription(Calculator.INPUT_LABEL_STANDARD_PRE_NONLINEARITY_CORRECTEE, false, true),
			new RepInputDescription(Calculator.INPUT_LABEL_STANDARD_POST_NONLINEARITY_CORRECTEE, true, false),
	...
	public OutputDescription[] getOutputDescription() {
		return new OutputDescription[] {
			...
			new RepOutputDescription(Calculator.OUTPUT_LABEL, "0.000", StandardParameter.Δ47, IsotopicScale.CDES, false)
		};
	}
}
