...
public class Controller extends org.easotope.shared.analysis.repstep.superclass.etfpbl.Controller {
	...
	public String getStepName() {
		return Messages.repStepD47ETFPBL_name;
	}

	@Override
	public String getShortDocumentation() {
		return Messages.repStepD47ETFPBL_shortDocumentation;
	}

	@Override
	public String getDocumentationPath() {
		return Messages.repStepD47ETFPBL_documentationPath;
	}
	...
	public String getGraphicComposite() {
		return "org.easotope.client.analysis.repstep.co2.d47etfpbl.GraphicComposite";
	}
