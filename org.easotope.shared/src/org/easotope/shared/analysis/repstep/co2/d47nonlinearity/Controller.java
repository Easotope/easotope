...
public class Controller extends org.easotope.shared.analysis.repstep.superclass.nonlinearity.Controller {
	...
	public String getStepName() {
		return Messages.repStepD47Nonlinearity_name;
	}

	@Override
	public String getShortDocumentation() {
		return Messages.repStepD47Nonlinearity_shortDocumentation;
	}

	@Override
	public String getDocumentationPath() {
		return Messages.repStepD47Nonlinearity_documentationPath;
	}
	...
	public String getGraphicComposite() {
		return "org.easotope.client.analysis.repstep.co2.d47nonlinearity.GraphicComposite";
	}
