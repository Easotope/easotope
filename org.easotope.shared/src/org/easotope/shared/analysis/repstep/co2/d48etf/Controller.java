...
public class Controller extends org.easotope.shared.analysis.repstep.superclass.etf.Controller {
	...
	public String getStepName() {
		return Messages.repStepD48ETF_name;
	}

	@Override
	public String getShortDocumentation() {
		return Messages.repStepD48ETF_shortDocumentation;
	}

	@Override
	public String getDocumentationPath() {
		return Messages.repStepD48ETF_documentationPath;
	}
	...
	public String getGraphicComposite() {
		return "org.easotope.client.analysis.repstep.co2.d48etf.GraphicComposite";
	}
