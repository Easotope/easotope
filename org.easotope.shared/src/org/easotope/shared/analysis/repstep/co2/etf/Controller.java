...
public class Controller extends StepController {
	...
	public String getStepName() {
		return Messages.repStepCO2OETF_name;
	}

	@Override
	public String getShortDocumentation() {
		return Messages.repStepCO2OETF_shortDocumentation;
	}

	@Override
	public String getDocumentationPath() {
		return Messages.repStepCO2OETF_documentationPath;
	}
	...
	public String getParameterComposite() {
		return "org.easotope.client.analysis.repstep.co2.etf.ParameterComposite";
	}

	@Override
	public String getGraphicComposite() {
		return "org.easotope.client.analysis.repstep.co2.etf.GraphicComposite";
	}
	...
	public InputDescription[] getInputDescription() {
		return new InputDescription[] {
			...
			new RepInputDescription(Calculator.INPUT_LABEL_STANDARD_δ47, false, true),
			new RepInputDescription(Calculator.INPUT_LABEL_STANDARD_PRE_NONLINEARITY_Δ47, false, true),
			new RepInputDescription(Calculator.INPUT_LABEL_STANDARD_POST_NONLINEARITY_Δ47, true, false),
	...
	public OutputDescription[] getOutputDescription() {
		return new OutputDescription[] {
			new RepOutputDescription(Calculator.OUTPUT_LABEL_ETF_SLOPE, null, null, null),
			new RepOutputDescription(Calculator.OUTPUT_LABEL_ETF_INTERCEPT, null, null, null),
