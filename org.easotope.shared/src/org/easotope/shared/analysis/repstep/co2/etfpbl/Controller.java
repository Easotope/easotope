...
public class Controller extends StepController {
	...
	public String getStepName() {
		return Messages.repStepCO2OETFPBL_name;
	}

	@Override
	public String getShortDocumentation() {
		return Messages.repStepCO2OETFPBL_shortDocumentation;
	}

	@Override
	public String getDocumentationPath() {
		return Messages.repStepCO2OETFPBL_documentationPath;
	}
	...
	public String getParameterComposite() {
		return "org.easotope.client.analysis.repstep.co2.etfpbl.ParameterComposite";
	}

	@Override
	public String getGraphicComposite() {
		return "org.easotope.client.analysis.repstep.co2.etfpbl.GraphicComposite";
	}
