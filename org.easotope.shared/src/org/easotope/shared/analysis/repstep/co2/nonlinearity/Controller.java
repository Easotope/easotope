...
public class Controller extends RepStepController {
	...
	public String getStepName() {
		return Messages.repStepCO2ONonlinearity_name;
	}

	@Override
	public String getShortDocumentation() {
		return Messages.repStepCO2ONonlinearity_shortDocumentation;
	}

	@Override
	public String getDocumentationPath() {
		return Messages.repStepCO2ONonlinearity_documentationPath;
	}
	...
	public String getParameterComposite() {
		return "org.easotope.client.analysis.repstep.co2.nonlinearity.ParameterComposite";
	}

	@Override
	public String getGraphicComposite() {
		return "org.easotope.client.analysis.repstep.co2.nonlinearity.GraphicComposite";
	}

	@Override
	public InputDescription[] getInputDescription() {
		return new InputDescription[] {
			new RepInputDescription(Calculator.INPUT_LABEL_SAMPLE_δ47, true, false),
			new RepInputDescription(Calculator.INPUT_LABEL_SAMPLE_Δ47, true, false),
			new RepInputDescription(Calculator.INPUT_LABEL_STANDARD_δ47, true, true),
			new RepInputDescription(Calculator.INPUT_LABEL_STANDARD_Δ47, true, true)
		};
	}
	...
	public OutputDescription[] getOutputDescription() {
		return new OutputDescription[] {
			new RepOutputDescription(Calculator.OUTPUT_LABEL_Δ47_δ47_SLOPE, null, null, null, false),
			new RepOutputDescription(Calculator.OUTPUT_LABEL_Δ47_δ47_INTERCEPTS, null, null, null, false),
