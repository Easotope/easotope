...
public class Controller extends org.easotope.shared.analysis.repstep.superclass.drift.Controller {
	...
	public String getStepName() {
		return Messages.repStepCO2ODrift_name;
	}

	@Override
	public String getShortDocumentation() {
		return Messages.repStepCO2ODrift_shortDocumentation;
	}

	@Override
	public String getDocumentationPath() {
		return Messages.repStepCO2ODrift_documentationPath;
	}

	@Override
	public final String getGraphicComposite() {
		return "org.easotope.client.analysis.repstep.co2.odrift.GraphicComposite";
	}
