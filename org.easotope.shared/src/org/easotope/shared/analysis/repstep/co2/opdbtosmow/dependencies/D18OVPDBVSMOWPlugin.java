...
package org.easotope.shared.analysis.repstep.co2.opdbtosmow.dependencies;
...
public class D18OVPDBVSMOWPlugin extends DependencyPlugin {
	private SciConstant sciConstant;

	D18OVPDBVSMOWPlugin() {
		super(SciConstantNames.δ18O_VPDB_VSMOW.toString());
	}
	...
	public int requestObject(DependencyManager dependencyManager) {
		return SciConstantCache.getInstance().sciConstantGet(SciConstantNames.δ18O_VPDB_VSMOW, dependencyManager);
	}
	...
	public boolean verifyCurrentObject(DependencyManager dependencyManager) {
		return sciConstant != null && sciConstant.getEnumeration() == SciConstantNames.δ18O_VPDB_VSMOW;
	}
