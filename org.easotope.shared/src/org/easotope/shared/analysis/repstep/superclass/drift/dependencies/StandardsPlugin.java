...
package org.easotope.shared.analysis.repstep.superclass.drift.dependencies;
...
public class StandardsPlugin extends DependencyPlugin {
	...
	public HashMap<String,String> getPrintableValues(DependencyManager dependencyManager) {
		...
		StandardParameter standardParameter = calculator.getStandardParameter();
		...
		for (Standard standard : standards) {
			...
			result.put(standard.getName(), (value == null) ? "UNDEFINED" : value);
		}
