...
public class Controller extends StepController {
	...
	public String getStepName() {
		return Messages.samStepClumpAverage48_name;
	}

	@Override
	public String getShortDocumentation() {
		return Messages.samStepClumpAverage48_shortDocumentation;
	}

	@Override
	public String getDocumentationPath() {
		return Messages.samStepClumpAverage48_documentationPath;
	}
