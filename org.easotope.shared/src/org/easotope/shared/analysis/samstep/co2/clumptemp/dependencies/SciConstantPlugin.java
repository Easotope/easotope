...
public class SciConstantPlugin extends DependencyPlugin {
	private SciConstantNames sciConstantName;
	private SciConstant sciConstant;

	SciConstantPlugin(SciConstantNames sciConstantName) {
		super(sciConstantName.toString());
		this.sciConstantName = sciConstantName;
	}
	...
	public int requestObject(DependencyManager dependencyManager) {
		return SciConstantCache.getInstance().sciConstantGet(sciConstantName, dependencyManager);
	}
	...
	public boolean verifyCurrentObject(DependencyManager dependencyManager) {
		return sciConstant != null && sciConstant.getEnumeration() == sciConstantName;
	}
