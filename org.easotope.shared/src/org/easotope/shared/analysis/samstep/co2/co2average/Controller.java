...
public class Controller extends StepController {
	...
	public String getStepName() {
		return Messages.samStepCO2Average_name;
	}

	@Override
	public String getShortDocumentation() {
		return Messages.samStepCO2Average_shortDocumentation;
	}

	@Override
	public String getDocumentationPath() {
		return Messages.samStepCO2Average_documentationPath;
	}
	...
	public InputDescription[] getInputDescription() {
		return new InputDescription[] {
			new SamInputDescription(Calculator.INPUT_LABEL_δ13C_VPDB, true),
			new SamInputDescription(Calculator.INPUT_LABEL_δ18O_VPDB, true)
		};
	}
