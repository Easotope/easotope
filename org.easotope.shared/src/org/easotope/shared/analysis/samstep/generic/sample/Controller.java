...
package org.easotope.shared.analysis.samstep.generic.sample;
...
public class Controller extends StepController {
	...
	public String getStepName() {
		return Messages.samStepGenericSample_name;
	}

	@Override
	public String getShortDocumentation() {
		return Messages.samStepGenericSample_shortDocumentation;
	}

	@Override
	public String getDocumentationPath() {
		return Messages.samStepGenericSample_documentationPath;
	}
