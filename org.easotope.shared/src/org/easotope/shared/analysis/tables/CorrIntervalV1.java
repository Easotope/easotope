...
@DatabaseTable(tableName=CorrIntervalV1.TABLE_NAME)
public class CorrIntervalV1 extends TableObjectWithIntegerId {
	private static final long serialVersionUID = 1L;

	public static final String TABLE_NAME = "CORRINTERVAL_V1";
	...
	public CorrIntervalV1() { }

	public CorrIntervalV1(CorrIntervalV1 corrInterval) {
		super(corrInterval);
		...
		if (corrInterval.channelToMzX10 != null) {
			this.channelToMzX10 = new Integer[corrInterval.channelToMzX10.length];

			for (int i=0; i<corrInterval.channelToMzX10.length; i++) {
				this.channelToMzX10[i] = corrInterval.channelToMzX10[i];
			}
		}
	}
