...
@DatabaseTable(tableName=RepStepParams.TABLE_NAME)
public class RepStepParams extends StepParams {
	private static final long serialVersionUID = 1L;

	public static final String TABLE_NAME = "REPSTEPPARAMS_V0";
	...
	public RepStepParams() { }

	public RepStepParams(RepStepParams repStepParameters) {
		super(repStepParameters);

		corrIntervalId = repStepParameters.corrIntervalId;
	}
