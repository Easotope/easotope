...
public class MassSpecGet extends Command {
	private static final long serialVersionUID = 1L;

	private int massSpecId;
	private MassSpec massSpec = null;
	private HashMap<Integer,Long> refGasList = new HashMap<Integer,Long>();
	...
	public void execute(ConnectionSource connectionSource, RawFileManager rawFileManager, Hashtable<String,Object> authenticationObjects) throws Exception {
		...
		massSpec = massSpecDao.queryForId(massSpecId);

		Dao<RefGas,Integer> refGasDao = DaoManager.createDao(connectionSource, RefGas.class);

		for (RefGas refGas : refGasDao.queryForEq(RefGas.MASSSPECID_FIELD_NAME, massSpecId)) {
			refGasList.put(refGas.getId(), refGas.getValidFrom());
		}
	}
	...
	public HashMap<Integer,Long> getRefGasList() {
		return refGasList;
	}
}
