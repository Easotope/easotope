...
public class AccumulatorStdDevSample {
	private Accumulator accumulator;

	private Pad owningPad;
	private String accumulatorColumn;

	AccumulatorStdDevSample(Accumulator accumulator) {
		this.accumulator = accumulator;
		owningPad = accumulator.getOwningPad();
		accumulatorColumn = accumulator.getProperty();
	}

	AccumulatorStdDevSample(Pad owningPad, String accumulatorColumn) {
	...
	public double getValue() {
		...
		return accumulator.getMeanStdDevSampleAndStdError()[1];
	}
