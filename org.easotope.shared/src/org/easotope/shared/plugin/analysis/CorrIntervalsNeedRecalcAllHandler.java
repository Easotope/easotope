...
public class CorrIntervalsNeedRecalcAllHandler {
	public ArrayList<Event> execute(CorrIntervalsNeedRecalcAll corrIntervalsNeedRecalcAll, RawFileManager rawFileManager, ConnectionSource connectionSource) {
		...
		try {
			...
			for (CorrIntervalV1 corrInterval : corrIntervalDao.queryForAll()) {
			...
			Log.getInstance().log(Level.INFO, this, "Error while recalculating all correction intervals.", e);
		}
