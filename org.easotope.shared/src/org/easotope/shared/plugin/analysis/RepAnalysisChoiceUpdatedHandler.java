...
public class RepAnalysisChoiceUpdatedHandler {

	public ArrayList<Event> execute(RepAnalysisChoiceUpdated event, RawFileManager rawFileManager, ConnectionSource connectionSource) {
