...
public class ReplicateUpdatedHandler {

	public ArrayList<Event> execute(ReplicateUpdated event, RawFileManager rawFileManager, ConnectionSource connectionSource) {
