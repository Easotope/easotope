...
@DatabaseTable(tableName=ReplicateV0.TABLE_NAME)
public class ReplicateV0 extends TableObjectWithIntegerId {
	private static final long serialVersionUID = 1L;

	public static final String TABLE_NAME = "REPLICATE_V0";
	...
	public ReplicateV0(ReplicateV0 replicate) {
		super(replicate);
