...
@DatabaseTable(tableName=ScanV0.TABLE_NAME)
public class ScanV0 extends TableObjectWithIntegerId {
	private static final long serialVersionUID = 1L;

	public static final String TABLE_NAME = "SCAN_V0";
	...
	@DatabaseField(columnName=INPUT_PARAMETERS, canBeNull=false, dataType=DataType.SERIALIZABLE)
	...
	public ScanV0(ScanV0 scan) {
		...
		this.inputParameters = scan.inputParameters.clone();
	...
	public InputParameter[] getInputParameters2() {
		return inputParameters;
	}

	public void setInputParameters2(InputParameter[] inputParameters) {
